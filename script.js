let tasks = [];
    ...
    function addTask() {
      ...
      const task = {
        ...
        status: 'pending',
        createdAt: new Date(),
        reminder: reminderTime.value ? new Date(reminderTime.value) : null
      };
    ...
    function renderTasks(priorityFilter = 'all', statusFilter = 'all') {
        ...
        taskCard.innerHTML = `
          <div class="task-info">
            ...
            <div class="task-meta">
              ...
              ${task.reminder ? `<span>⏰ ${new Date(task.reminder).toLocaleString()}</span>` : ''}
            </div>
          </div>
          <div class="actions">
